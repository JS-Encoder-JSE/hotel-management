      ...
      {!isLoading ? (
          ...
          >
            <div className="relative bg-white p-3 pb-14 text-right rounded shadow hover:shadow-md duration-200">
              ...
              <p className="text-2xl font-semibold mt-3">
                {Math.floor(dailyData?.today_checkin)}
              </p>
              <hr />
              {user.role === "manager" ? (
                <div>
                  ...
                  <p className="text-2xl font-semibold mt-4">
                    {Math.floor(dailyData?.today_checkout)}
                  </p>
                </div>
              ) : user.role === "owner" ? (
                <div>
            ...
            <div className="relative bg-white p-3 pb-14 text-right rounded shadow hover:shadow-md duration-200">
              ...
              <p className="text-2xl font-semibold mt-4">
                {Math.floor(permanentData?.total_amount)}
              </p>
              <hr />
            </div>
            {user.role === "admin" ? (
            ...
            <div className="relative bg-white p-3 pb-14 text-right rounded shadow hover:shadow-md duration-200">
              ...
              <p className="text-2xl font-semibold mt-4">
                {Math.floor(permanentData?.total_checkin)}
              </p>
              <hr />
              {user.role === "manager" ? (
                <div>
                  ...
                  <p className="text-2xl font-semibold mt-4">
                    {Math.floor(permanentData?.total_checkout)}
                  </p>
                </div>
              ) : user.role === "owner" ? (
                <div>
        ...
        <hr />
          ...
          <section className="bg-white p-3 mt-8 rounded shadow hover:shadow-md duration-200">
            <CustomerReservation
              monthlyData={[...monthlyData, ...dummyData]}
              userHotel={userHotel}
            />
          </section>
