...
const AddRoom = () => {
	...
	const { data: hotelsList, isLoading: loading } =
		useGetRoomsAndHotelsQuery();
					...
					<div className="card-body">
						...
						<form
							...
							<div className="flex flex-col gap-3">
								...
								{formik.touched.hotel_id &&
								Boolean(formik.errors.hotel_id) ? (
							...
							<div className="flex flex-col gap-3">
								...
								{formik.touched.bedSize &&
								Boolean(formik.errors.bedSize) ? (
									<small className="text-red-600">
										{formik.touched.bedSize &&
											formik.errors.bedSize}
									</small>
								) : null}
							</div>
							{/* floor number box */}
