...
const BillingSectionPrint = ({ data, totalBilling, setTotalBilling, setPBill }) => {


    const billingState = useSelector((state) => state.checkoutInfoCalSlice);
    console.log(billingState)
    const { subTotals, tax, serviceCharge, additionalCharge, discountOffer, grandTotal } = billingState;
