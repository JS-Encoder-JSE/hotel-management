...
import { addBarOrder, getBarOrderById, getBarOrdersByHotelId, updateBarOrder } from "../../controllers/Manager/bar.controller.js";
...
router.get("/get-bar-orders-by-hotel/:hotel_id",checkToken, getBarOrdersByHotelId);
